...
const Electrical = () => {
    ...
    const _getAllDocumentsPerDepartment = async () => {
        try {
            const data = await getAllDocumentPerDepartment("Bachelor of Science in Electrical Engineering (BSEE)");
            setDocuments(data);
        } catch (error) {
            setDocuments([]);
        }
    ...
    return (
        <ResponsiveDrawer>
            <PageTitle
                ...
                description="All Bachelors Thesis for the course of Electrical Engineering can be found here."
            />
