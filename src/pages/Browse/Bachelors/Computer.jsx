...
const Computer = () => {
    ...
    const _getAllDocumentsPerDepartment = async () => {
        try {
            const data = await getAllDocumentPerDepartment("Bachelor of Science in Computer Engineering (BSCoE)");
            setDocuments(data);
        } catch (error) {
            setDocuments([]);
        }
    ...
    return (
        <ResponsiveDrawer>
            <PageTitle
                title="Bachelor of Science in Computer Engineering (BSCoE)"
                description="All Bachelors Thesis for the course of Computer Engineering can be found here."
            />
