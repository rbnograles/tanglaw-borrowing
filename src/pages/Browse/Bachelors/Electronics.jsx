...
const Electronics = () => {
    ...
    const _getAllDocumentsPerDepartment = async () => {
        try {
            const data = await getAllDocumentPerDepartment("Bachelor of Science in Electronics Engineering (BSECE)");
            setDocuments(data);
        } catch (error) {
            setDocuments([]);
        }
    ...
    return (
        <ResponsiveDrawer>
            <PageTitle
                ...
                description="All Bachelors Thesis for the course of Electronics Engineering can be found here."
            />
