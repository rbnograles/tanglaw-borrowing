...
const DiplomaCivil = () => {
    ...
    const _getAllDocumentsPerDepartment = async () => {
        try {
            const data = await getAllDocumentPerDepartment("Diploma in Railway Engineering Technology (DRET)");
            setDocuments(data);
        } catch (error) {
            setDocuments([]);
        }
    ...
    return (
        <ResponsiveDrawer>
            <PageTitle
                title="Diploma in Railway Engineering Technology (DRET)"
                description="All Thesis for the Diploma in the course of Railway Engineering can be found here."
            />
