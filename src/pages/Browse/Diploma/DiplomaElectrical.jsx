...
const DiplomaElectrical = () => {
    ...
    const _getAllDocumentsPerDepartment = async () => {
        try {
            const data = await getAllDocumentPerDepartment("Diploma in Electrical Engineering Technology (DEET)");
            setDocuments(data);
        } catch (error) {
            setDocuments([]);
        }
    ...
    return (
        <ResponsiveDrawer>
            <PageTitle
                title="Diploma in Electrical Engineering Technology (DEET)"
                description="All Thesis for the Diploma in the course of Electrical Engineering can be found here."
            />
...
export default DiplomaElectrical;
