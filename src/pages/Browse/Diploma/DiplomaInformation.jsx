...
const DiplomaITech = () => {
    ...
    const _getAllDocumentsPerDepartment = async () => {
        try {
            const data = await getAllDocumentPerDepartment("Diploma in Information Communication Technology (DICT)");
            setDocuments(data);
        } catch (error) {
            setDocuments([]);
        }
    ...
    return (
        <ResponsiveDrawer>
            <PageTitle
                ...
                description="All Thesis for the Diploma in the course of Information Communication Technology can be found here."
            />
