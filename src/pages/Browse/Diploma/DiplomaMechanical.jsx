...
const DiplomaMechanical = () => {
    ...
    const _getAllDocumentsPerDepartment = async () => {
        try {
            const data = await getAllDocumentPerDepartment("Diploma in Mechanical Engineering Technology (DMET)");
            setDocuments(data);
        } catch (error) {
            setDocuments([]);
        }
    ...
    return (
        <ResponsiveDrawer>
            <PageTitle
                title="Diploma in Mechanical Engineering Technology (DMET)"
                description="All Thesis for the Diploma in the course of Mechanical Engineering can be found here."
            />
...
export default DiplomaMechanical;
