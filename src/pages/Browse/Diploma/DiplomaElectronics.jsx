...
const DiplomaElectronics = () => {
    ...
    const _getAllDocumentsPerDepartment = async () => {
        try {
            const data = await getAllDocumentPerDepartment("Diploma in Electronics Engineering Technology (DECET)");
            setDocuments(data);
        } catch (error) {
            setDocuments([]);
        }
    ...
    return (
        <ResponsiveDrawer>
            <PageTitle
                title="Diploma in Electronics Engineering Technology (DECET)"
                description="All Thesis for the Diploma in the course of Electronics Engineering can be found here."
            />
...
export default DiplomaElectronics;
