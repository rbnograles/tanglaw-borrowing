...
const Index = () => {
    ...
    const { checkUserTypeAndRedirect, getUserProfile, updateLastLoginDate } = UserProfile();
    ...
    const signIn = async () => {
        ...
        try {
            ...
            if(user) {
                ...
                await createSystemLogs("Logged in to the system.", email, profile[0].userType);
                const userType = await checkUserTypeAndRedirect(user.user.uid, currentRedner);
            ...
            <div className="pane">
                ...
                <div className="indexbutton">
                    ...
                    <section className="indextos">
                        <p>By using this service, you understood and agree to the Tanglaw Online Services 
                        <a href="https://www.Tanglaw.edu.ph/terms/"> Terms of Use</a> and
                        <a href="https://www.Tanglaw.edu.ph/privacy/"> Privacy Statement</a>.</p>
                    </section>
                </div>
            </div>
        </div>
            ...
            <Fragment>
                ...
                <div className='flex flex-col button-container'>
                    <Button 
                        ...
                        onClick={() => { setCurrentRender('student') }}
                    >
                        Student
                    </Button>
                    <Button 
                        className="button red" 
                        onClick={() => { setCurrentRender('faculty') }}
                    >
                        Faculty
                    </Button>
                </div>
